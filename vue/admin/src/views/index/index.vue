    ...
    <el-row :gutter="32">
      ...
      <el-col :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          ...
          <tag-cloud v-if="tagLoad" :tag-list="tagList" />
        </div>
      </el-col>
    </el-row>
...
import type { TagOption } from '@/api/article/types';
import blogApi from '@/api/blog';
import type { ArticleStatisticsVO } from '@/api/blog/types';
...
const getList = () => {
  blogApi.getBlogInfo().then(({ data }) => {
    ...
    if (data.data.userViewList != null) {
      data.data.userViewList.forEach((item) => {
